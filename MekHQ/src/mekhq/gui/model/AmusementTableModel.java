 ...
 */
public class AmusementTableModel extends DataTableModel {
    private final Campaign campaign;

    public AmusementTableModel(Campaign c) {
        columnNames = new String[] { "Entertainment" };
    ...
    public AmusementTableModel.Renderer getRenderer() {
        return new AmusementTableModel.Renderer();
    }
